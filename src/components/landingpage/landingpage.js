    ...
    return (
        <div>
            <div className="intro">
                ...
                <div className="about__section">
                    <div data-aos="fade-up">
                        ...
                        <p style={{ color: "#ac4b1c" }}>
                            ...
                            this you'll find me into sports especially Football. Ask me out for Swimming and you would'nt be disappointed. Travelling is fun since <strong style={{ color: "#f16821" }}>SAINT AUSTINE</strong> has already said "THE WORLD IS A BOOK AND
                ...
                <h1 className="ques" data-aos="fade-down-right">Interested in doing project together ?</h1>
