    ...
    <div style={{ position: "relative" }}>
      ...
      <div className={`navbar__links ${showHamburger ? "isOpen" : ""}`}>
        <span onClick={clickHandler}>
          <NavLink to="/Gitfolio" exact activeClassName="linkActive">
            Home
          </NavLink>
        </span>
        <span onClick={clickHandler}>
          <NavLink to="/Gitfolio/repo" activeClassName="linkActive">
            Portfolio
          </NavLink>
        </span>
        <span onClick={clickHandler}>
          <NavLink to="/Gitfolio/contact" activeClassName="linkActive">
            Contact Me
          </NavLink>
        </span>
        {/* <span>
